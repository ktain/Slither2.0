...
#define	read_Outz	       	 readADC(ADC1, 8,  ADC_SampleTime_480Cycles)
#define	read_Vref	         readADC(ADC1, 9,  ADC_SampleTime_480Cycles)
#define read_Rate					 readADC(ADC1, 7, ADC_SampleTime_480Cycles)
